...
const TABLE_CONFIGS = [
  ...
  },
  {
    ...
    table: "courses",
    pk: ["id"],
    toRow: (c) => ({ id: c.id, name: c.name, subject: c.subject || "", day_of_week: c.dayOfWeek, start_time: c.start, end_time: c.end, teacher_id: c.teacherId || null }),
    fromRow: (r) => ({ id: r.id, name: r.name, subject: r.subject || "", dayOfWeek: r.day_of_week, start: r.start_time, end: r.end_time, teacherId: r.teacher_id || "" }),
  },
  {
    key: "enrollments",
    table: "enrollments",
